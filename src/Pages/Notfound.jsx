    ...
    return (
        <>
            <div className="d-none">
                ...
                <h4 className="font-weight-bold m-0 text-white">Not Found</h4>
                </div>
            </div>
            <div className="container osahan-coming-soon py-5 d-flex justify-content-center align-items-center">
                ...
                <button onClick={ goToBack } className="btn btn-primary">Go Back</button>
                <a href="#" className="btn btn-light">Help</a>
                </div>
            </div>
            </>
